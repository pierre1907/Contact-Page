...
<html lang="en">
  ...
  <head>
    <title>Ameesis &mdash; Contact</title>
    <meta charset="utf-8">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
      ...
      <header class="site-navbar site-navbar-target" role="banner">
        ...
        <div class="container">
          <div class="row align-items-center position-relative">
            ...
            <div class="col-3 ">
              <div class="site-logo">
                <a href="https://ameesis.egs-expertise.com/" class="font-weight-bold">AMEESIS</a>
              </div>
            </div>
            ...
            <div class="col-9  text-right">
              ...
              <nav class="site-navigation text-right ml-auto d-none d-lg-none" role="navigation">
                <ul class="site-menu main-menu js-clone-nav ml-auto ">
                  ...
                  <li ><a href="https://ameesis.egs-expertise.com/"  class="nav-link">Site princpal</a></li>
                  <li><a href="https://ameesis.egs-expertise.com/historique/" class="nav-link">A propos de nous</a></li>
    ...
    <div class="ftco-blocks-cover-1">
      <div class="site-section-cover overlay" style="background-image: url('images/Bureau.jpg')">
        <div class="container">
          <div class="row align-items-center justify-content-center">
            <div class="col-md-7 text-center">
              <h1 class="mb-4 text-white" data-aos="fade-up">Contactez nous</h1>
              <p class="mb-4" data-aos="fade-up" data-aos-delay="150">Merci de bien vouloir nous indiquer votre/vos préocuppation(s) notre équipe technique vous contacteras dans les plus brèfs délais.
                  <br> Merci pour votre comprehension.
                  <br> Ensemble nous construisons la Côte d'Ivoire de demain
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-lg-8 ml-auto" >
            ...
            <form method="POST">
              ...
              <style>
                ...
                .textofcheck:hover input ~ .checkmark {
                  background-color: #ccc;
                }

                /* When the checkbox is checked, add a blue background */
                .textofcheck input:checked ~ .checkmark {
                ...
                .textofcheck input:checked ~ .checkmark:after {
                  display: block;
                }

                /* Style the checkmark/indicator */
                .textofcheck .checkmark:after {
                  left: 9px;
                  top: 5px;
                  width: 5px;
                  height: 10px;
          ...
          <div class="col-lg-4 ml-auto">
            <div class="bg-white p-3 p-md-5">
              <h2 class="text-black mb-4">Nous joindre</h2>
              <ul class="list-unstyled footer-link">
                <li class="d-block mb-3">
                  <strong>
                    <span class="d-block text-black">Adresse</span>
                  </strong>
                  <span>Ambassade de la République de Côte d’Ivoire Avenue Birago Diop</span></li>
                <li class="d-block mb-3">
                  <strong>
                    <span class="d-block text-black">Téléphone:</span>
                  </strong>
                  <span>+221 77 465 59 52 <br> +221 77 864 14 60</span>
                </li>
                <li class="d-block mb-3">
                  <strong>
                  <span class="d-block text-black">Email:</span>
                  </strong>
                  <a href="mailto: ameesis.dakar@gmail.com">
                      <span>ameesis.dakar@gmail.com</span>
                  </a>
                </li>
              </ul>
            </div>
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-7 mx-auto text-center">
            <h2 class="heading-29190">Notre équipe technique</h2>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6 col-lg-3">
            <div class="service-29128 text-center">
              <span class="d-block wrap-icon">
                <img src="images/Saint-Pierre KASSI.jpg" style="height: 250px; width: 200px">
              </span>
              <h3>Saint-Pierre KASSI</h3>
              <p>Web, mobile and Desktop devoloper</p>
            </div>
          </div>
          <div class="col-md-6 col-lg-3">
            <div class="service-29128 text-center">
          ...
          <div class="col-md-6 col-lg-3">
            <div class="service-29128 text-center">
              <span class="d-block wrap-icon">
                <img src="images/Amzah Youssef.jpg" style="height: 250px; width: 200px">
              </span>
              <h3>Amzah COULIBALY</h3>
              <p>Etudiant en 4e année de medecine</p>
            </div>
          </div>
          <div class="col-md-6 col-lg-3">
            <div class="service-29128 text-center">
              <span class="d-block wrap-icon">
                <img src="images/Fatou SENE.png" style="height: 250px; width: 200px">
              </span>
              <h3>Fatou Bintou SENE</h3>
              <p>Master 2 qualité sécurité hygiène et environnement</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <footer class="site-footer">
      <div class="container">
        <div class="row">
          <div class="col-lg-3">
            <h2 class="footer-heading mb-3">A PROPOS DE NOUS</h2>
                <p>
                  L’AMEESIS, Amicale des Élèves, Étudiants et Stagiaires ivoiriens au Sénégal est
                  comme son nom l’indique , est une association pour les élèves étudiants ivoiriens
                  sur le sol Sénégalais permettant leur insertion au sein de la communauté estudiantine et visant à
                  travailler ensemble pour un bon développement culturel, fraternel, et surtout intellectuel.
                </p>
          </div>
          <div class="col-lg-8 ml-auto">
            <div class="row">
              <div class="col-lg-6 ml-auto">
                ...
                <ul class="list-unstyled">
                  <li><a href="https://ameesis.egs-expertise.com/">Site principal</a></li>
              ...
              <div class="col-lg-6">
                <h2 class="footer-heading mb-4">Connectez vous à nous:</h2>
                <div class="social_29128 white mb-5">
                  <a href="https://www.facebook.com/AMEESISOFFICIEL/"><span class="icon-facebook"></span></a>
                  <a href="https://instagram.com/ameesis_officiel?igshid=YmMyMTA2M2Y="><span class="icon-instagram"></span></a>
                  <a href="https://twitter.com/ameesisenegal?s=21&t=P6u1_ECydKRC9A0JKcMc-A"><span class="icon-twitter"></span></a>
                 </div>
                <!--
        ...
        <div class="row pt-5 mt-5 text-center">
          <div class="col-md-12">
            ...
            Copyright &copy;<script>document.write(new Date().getFullYear());</script> Tous les droits sont réservés | Ce modèle est réalisé par <a href="https://www.linkedin.com/in/saint-pierre-eliakim-kassi-2b6053233/" target="_blank" >Saint-Pierre KASSI</a>
            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
            </div>
          </div>
